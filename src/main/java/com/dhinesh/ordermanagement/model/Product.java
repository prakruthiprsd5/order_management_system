package com.dhinesh.ordermanagement.model;
...
public class Product {
	...
	@Min(value=1, message="Product price can not be Zero.")
	private float productPrice;
	
	@Min(value=1, message="Product quantity can not be Zero")
	@Max(value=1000, message="Product quantity can be maximum 1000.")
